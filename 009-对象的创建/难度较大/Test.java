...
/*
	...
	思考：
		引用一定是局部变量吗？
			不一定。地址赋给了栈里面的对象,则不是局部变量了
*/
public class Test{
	public static void main(String[] args){

		//报错了。id是实例变量，必须先创建对象，必须通过“引用.”的方式访问。这是类名方式访问的
		...
		*/
		...
		u.id = 11111;
		u.username = "zhangsan";
		u.addr = a;//---相当于把Address a中存放的地址给了u.addr  Address指向的地址是堆内存里面的(Address类型的对象都在里面存着)
		...
		Address ad = u.addr;  //u.addr 就是Address,相当于int=10; 10是int
